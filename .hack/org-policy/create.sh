...
name: folders/$1/policies/compute.requireShieldedVm
spec:
  rules:
  - enforce: false
ENDOFFILE
...
name: folders/$1/policies/compute.vmCanIpForward
spec:
  rules:
  - allowAll: true
ENDOFFILE
...
name: folders/$1/policies/compute.vmExternalIpAccess
spec:
  rules:
  - allowAll: true
ENDOFFILE
...
name: folders/$1/policies/compute.restrictVpcPeering
spec:
  rules:
  - allowAll: true
ENDOFFILE
